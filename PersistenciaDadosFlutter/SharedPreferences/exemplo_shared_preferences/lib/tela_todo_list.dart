...
class _TelaTodoListState extends State<TelaTodoList> {
  ...
  void _carregarPreferencias() async {
    SharedPreferences _prefs =
        await SharedPreferences.getInstance(); //estabelece conexao memoria
    _nome = _prefs.getString("nome") ?? ""; //pega as informações do nome
    _darkMode =
        _prefs.getBool("darkMode") ?? false; //pega informações do darkmode
    _chaveLista = "lista${_nome}"; //controe a chave da lista
    _tarefas =
