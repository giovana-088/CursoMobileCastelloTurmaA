...
class _TarefasViewState extends State<TarefasView> {
  ...
  final User? _user = FirebaseAuth.instance.currentUser; //pega o usuario logado atualmente
...
//addTarefa
  ...
  //updadeTarefa
  void _updateTarefa(String tarefaID, bool statusTarefas) async{
    await _db.collection("usuarios")
    .doc(_user!.uid)
    .collection("tarefas")
    .doc(tarefaID)
    .update({"concluida":!statusTarefas}); //inverte o status da tarefa
  }
  ...
  //listar tarefas será feita diretamente no build da tela 
            ...
            child: StreamBuilder<QuerySnapshot>( //dependendo do resultado da Query exibe a tela desejada
              ...
              builder: (context, snapshot){
                ...
                if(!snapshot.hasData || snapshot.data!.docs.isEmpty){
                  return Center(child: Text("Nenhuma Tarefas Cadastradas"),);
                }
                //exibir as tarefas
                ...
                return ListView.builder(
                 itemCount: tarefas.length, //conta o numero de tarefas no vetor
                  itemBuilder: (context, index){
                    ...
                    // bool concluida = tarefaMap["concluida"] ?? false; // se for u nulo
                    //fazer oo item da lista
                    return ListTile(
